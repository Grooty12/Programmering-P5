// Guitar Strings and Picture samt koordinater
let String1;
let String1X = 175;
let String1Y = 220;
let String1W = 800;
...
// Drums samt deres koordinater og diameter
let BassDrum;
let BassDrumX = 1200;
let BassDrumY = 800;
let BassDrumD = 150;
...
function draw() {
  background(50);
  // Guitar
  image(imgGuitar, 0, 0, 2400 / 2, 778 / 2); // billed af guitar
  if (
    mouseX > String1X &&
    mouseX < String1X + String1W &&
    mouseY > String1Y &&
    mouseY < String1Y + String1H
  ) {
    // Hvis musen er over streng 1 afspilles lyd. Samme nedenfor
    String1.play();
  }
  if (
    mouseX > String2X &&
    mouseX < String2X + String2W &&
    mouseY > String2Y &&
    mouseY < String2Y + String2H
  ) {
    // String 2
    String2.play();
  }
  if (
    mouseX > String3X &&
    mouseX < String3X + String3W &&
    mouseY > String3Y &&
    mouseY < String3Y + String3H
  ) {
    // String 3
    String3.play();
  }
  if (
    mouseX > String4X &&
    mouseX < String4X + String4W &&
    mouseY > String4Y &&
    mouseY < String4Y + String4H
  ) {
    // String 4
    String4.play();
  }
  if (
    mouseX > String5X &&
    mouseX < String5X + String5W &&
    mouseY > String5Y &&
    mouseY < String5Y + String5H
  ) {
    // String 5
    String5.play();
  }
  if (
    mouseX > String6X &&
    mouseX < String6X + String6W &&
    mouseY > String6Y &&
    mouseY < String6Y + String6H
  ) {
    // String 6
    String6.play();
  }
  ...
  // Piano
  noStroke();
  fill(250); // Laver alle de hvide Piano keys
  ...
  fill(10); // Lavver alle de sorte Piano keys
...
function mousePressed() {
  // Hvis musen er trykket tjekker om musen er over de forskellige firkanter eller cirkler for klaver eller trommer. Spiller lyd hvis ja
  // Piano White
  if (
    mouseX > Piano1X &&
    mouseX < Piano1X + PianoWW &&
    mouseY > PianoY &&
    mouseY < PianoY + PianoHW
  ) {
    Piano1.play();
  }
  if (
    mouseX > Piano3X &&
    mouseX < Piano3X + PianoWW &&
    mouseY > PianoY &&
    mouseY < PianoY + PianoHW
  ) {
    Piano3.play();
  ...
  if (
    mouseX > Piano2X &&
    mouseX < Piano2X + PianoWB &&
    mouseY > PianoY &&
    mouseY < PianoY + PianoHB
  ) {
    Piano2.play();
  }
  if (
    mouseX > Piano4X &&
    mouseX < Piano4X + PianoWB &&
    mouseY > PianoY &&
    mouseY < PianoY + PianoHB
  ) {
    Piano4.play();
  ...
  // Drums
  if (
    sqrt((mouseX - BassDrumX) ** 2 + (mouseY - BassDrumY) ** 2) <
    BassDrumD / 2
  ) {
    BassDrum.play();
  }
  if (
    sqrt((mouseX - SnareDrumX) ** 2 + (mouseY - SnareDrumY) ** 2) <
    SnareDrumD / 2
  ) {
    SnareDrum.play();
  }
  if (
    sqrt((mouseX - FloorTomX) ** 2 + (mouseY - FloorTomY) ** 2) <
    FloorTomD / 2
  ) {
    FloorTom.play();
  }
  if (
    sqrt((mouseX - LowTomTomX) ** 2 + (mouseY - LowTomTomY) ** 2) <
    LowTomTomD / 2
  ) {
    LowTomTom.play();
  }
  if (
    sqrt((mouseX - HighTomTomX) ** 2 + (mouseY - HighTomTomY) ** 2) <
    HighTomTomD / 2
  ) {
    HighTomTom.play();
  }
  if (
    sqrt((mouseX - HighHatX) ** 2 + (mouseY - HighHatY) ** 2) <
    HighHatD / 2
  ) {
    HighHat.play();
  }
  if (
    sqrt((mouseX - RideCymbalX) ** 2 + (mouseY - RideCymbalY) ** 2) <
    RideCymbalD / 2
  ) {
    RideCymbal.play();
  }
  if (
    sqrt((mouseX - CrashCymbalX) ** 2 + (mouseY - CrashCymbalY) ** 2) <
    CrashCymbalD / 2
  ) {
    CrashCymbal.play();
  }
