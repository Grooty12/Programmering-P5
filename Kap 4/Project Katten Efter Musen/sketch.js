...
function draw() {
  ...
  if (Game == 1) {
    ...
    Cat1SpeedX =
      ((CatSpeed + 0.5) / sqrt((HBMX - Cat1HBX) ** 2 + (HBMY - Cat1HBY) ** 2)) *
      (HBMX - Cat1HBX);
    Cat1SpeedY =
      ((CatSpeed + 0.5) / sqrt((HBMX - Cat1HBX) ** 2 + (HBMY - Cat1HBY) ** 2)) *
      (HBMY - Cat1HBY);
    Cat2SpeedX =
      (CatSpeed / sqrt((HBMX - Cat2HBX) ** 2 + (HBMY - Cat2HBY) ** 2)) *
      (HBMX - Cat2HBX);
    Cat2SpeedY =
      (CatSpeed / sqrt((HBMX - Cat2HBX) ** 2 + (HBMY - Cat2HBY) ** 2)) *
      (HBMY - Cat2HBY);
    ...
    if (
      sqrt((HBMX - Cat1HBX) ** 2 + (HBMY - Cat1HBY) ** 2) < Cat1HBR + HBMR ||
      sqrt((HBMX - Cat2HBX) ** 2 + (HBMY - Cat2HBY) ** 2) < Cat2HBR + HBMR
    ) {
      Cat1X = random(imgCat1X, width - imgCat1X);
      Cat1Y = random(imgCat1Y, height - imgCat1Y);
      Cat2X = random(imgCat2X, width - imgCat2X);
